...
// 지금 현재까지는 컴포넌트들을 싸그리 다 분할 했었는데, 다층 구조의 상위 컴포넌트와 하위 컴포넌트로 나누어서 작성하는 방법을 사용할 예정입니다.
...
function LoginForm() {
  ...
  return(
    <form onSubmit={handleLoginForm} id="style1">
      <div id="inbox">
        <label>
          Id :
          <input type="text" value={id} onChange={handleIdInput}
